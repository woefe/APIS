...
function remove_owncloud(){
   ...
   apt-get $APT_GET_FLAG purge nginx-common nginx-full nginx php5 php5-common php5-cgi php5-gd php-xml-parser php5-intl sqlite php5-sqlite libcurl3 php5-curl php-pear php-apc php5-fpm memcached php5-memcache varnish
